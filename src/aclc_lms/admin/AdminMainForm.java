 ...
 */
public final class AdminMainForm extends javax.swing.JFrame {
    
    private final Config config = new Config();
    private final Helper helper = new Helper(AdminMainForm.class.getName());
    ...
    private void setComboBoxModel(){
        ResultSet leaveTypeResultSet = model.getAllLeaveType();
        ...
        try {
            ...
            txtLeaveType.setModel(new DefaultComboBoxModel(leaveTypeSet));
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPane8, javax.swing.GroupLayout.DEFAULT_SIZE, 1244, Short.MAX_VALUE))
                .addContainerGap())
        );
