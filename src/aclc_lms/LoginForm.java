...
import aclc_lms.admin.AdminMainForm;
...
public class LoginForm extends javax.swing.JFrame {
    ...
    public LoginForm() {
        ...
        this.initGUI();
        model = new Model();
        helper = new Helper(LoginForm.class.getName());
    }
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        if (inputValidation()) {
            ...
            ResultSet resultSet = model.auth(txtUsername.getText(), txtPassword.getText());
            try {
                if (resultSet.next()) {
                    if (resultSet.getString("department").equals("Admin")) {
